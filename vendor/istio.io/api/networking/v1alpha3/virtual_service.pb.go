...
type HTTPRedirect_RedirectType int32

const (
	// Moved Permanently HTTP Status Code - 301.
	HTTPRedirect_MOVED_PERMANENTLY HTTPRedirect_RedirectType = 0
	// Found HTTP Status Code - 302.
	HTTPRedirect_FOUND HTTPRedirect_RedirectType = 1
	// See Other HTTP Status Code - 303.
	HTTPRedirect_SEE_OTHER HTTPRedirect_RedirectType = 2
	// Temporary Redirect HTTP Status Code - 307.
	HTTPRedirect_TEMPORARY_REDIRECT HTTPRedirect_RedirectType = 3
	// Permanent Redirect HTTP Status Code - 308.
	HTTPRedirect_PERMANENT_REDIRECT HTTPRedirect_RedirectType = 4
)

var HTTPRedirect_RedirectType_name = map[int32]string{
	0: "MOVED_PERMANENTLY",
	1: "FOUND",
	2: "SEE_OTHER",
...
var HTTPRedirect_RedirectType_value = map[string]int32{
	"MOVED_PERMANENTLY":  0,
	"FOUND":              1,
	"SEE_OTHER":          2,
...
func (x HTTPRedirect_RedirectType) String() string {
	return proto.EnumName(HTTPRedirect_RedirectType_name, int32(x))
}
func (HTTPRedirect_RedirectType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorVirtualService, []int{7, 0}
}
...
type HTTPRoute struct {
	...
	// send HTTP redirect to a different URI or Authority.
...
// HTTPRedirect can be used to send specified redirect response to the caller,
...
type HTTPRedirect struct {
	...
	// Optional: Specify HTTP redirect response type. Default is FOUND (HTTP 302).
	Type HTTPRedirect_RedirectType `protobuf:"varint,3,opt,name=type,proto3,enum=istio.networking.v1alpha3.HTTPRedirect_RedirectType" json:"type,omitempty"`
}
...
func (m *HTTPRedirect) GetType() HTTPRedirect_RedirectType {
	if m != nil {
		return m.Type
	}
	return HTTPRedirect_MOVED_PERMANENTLY
}
...
func init() {
	...
	proto.RegisterEnum("istio.networking.v1alpha3.HTTPRedirect_RedirectType", HTTPRedirect_RedirectType_name, HTTPRedirect_RedirectType_value)
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (HTTPRedirect_RedirectType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorVirtualService = []byte{
	...
	,
}
